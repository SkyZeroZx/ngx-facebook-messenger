...
export interface FacebookStatic {
  ...
  CustomerChat: {
    /**
     * Call this function to show the plugin on your page.
     * You can use the shouldShowDialog parameter to decide if the dialog should also be shown.
     * For the plugin to stay hidden on initial page load, you have to set xfbml as false when initializing the SDK.
     * Then you can call FB.XFBML.parse() to control when Customer Chat is loaded.
     */
    ...
    hideDialog(): void;
    /**
     * This function allows you to update the greeting text and/or the ref params as specified in the Customer Chat reference.
     * Call FB.CustomerChat.update with a JSON object with the new values.
     ...
     *   });
     */
    update(customerChatUpdate: CustomerChatUpdate): void;
  };
